...
//
// Code for Hello::sayHello

// Proxy call descriptor class. Mangled signature:
//  _cstring
class _0RL_cd_fe687ede08da672a_00000000
  : public omniCallDescriptor
{
public:
  inline _0RL_cd_fe687ede08da672a_00000000(LocalCallFn lcfn, const char* op_, size_t oplen, _CORBA_Boolean upcall=0)
...
void _0RL_cd_fe687ede08da672a_00000000::marshalReturnedValues(cdrStream& _n)
{
  _n.marshalString(result,0);

}

void _0RL_cd_fe687ede08da672a_00000000::unmarshalReturnedValues(cdrStream& _n)
{
  result = _n.unmarshalString(0);

}

const char* const _0RL_cd_fe687ede08da672a_00000000::_user_exns[] = {
  0
};

// Local call call-back function.
static void
_0RL_lcfn_fe687ede08da672a_10000000(omniCallDescriptor* cd, omniServant* svnt)
{
  _0RL_cd_fe687ede08da672a_00000000* tcd = (_0RL_cd_fe687ede08da672a_00000000*)cd;
...
char* _objref_Hello::sayHello()
{
  _0RL_cd_fe687ede08da672a_00000000 _call_desc(_0RL_lcfn_fe687ede08da672a_10000000, "sayHello", 9);
...
_impl_Hello::_dispatch(omniCallHandle& _handle)
{
  ...
  if (omni::strMatch(op, "sayHello")) {
    ...
    _0RL_cd_fe687ede08da672a_00000000 _call_desc(_0RL_lcfn_fe687ede08da672a_10000000, "sayHello", 9, 1);
